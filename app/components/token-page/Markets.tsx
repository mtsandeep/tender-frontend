                    ...
                    >
                        ...
                        >
                            {total?.supply?.topMarkets.map((id: string, index: number) => {
                                const m = markets[id];
                                const marketPercentage = (m.totalSupplyUsd * 100 / total.supply.usd).toFixed(2);
                    ...
                    >
                        ...
                        >
                            {total?.borrow?.topMarkets.map((id: string, index: number) => {
                                const m = markets[id];
                                const marketPercentage = (m.totalBorrowUsd * 100 / total.borrow.usd).toFixed(2);

                                return (
                                    <div key="1" className="flex flex-col gap-y-[10px]">
                                        <label
                                            className="flex justify-between text-[14px] md:text-[16px] leading-[20px] md:leading-[22px]">
                                            <p className="uppercase">{m.symbol}</p>
