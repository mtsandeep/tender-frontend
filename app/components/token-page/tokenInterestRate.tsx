...
function TokenInterestRate() {
  const data = [
    { aa: 0, ss: 0, dd: 0 },
    { aa: 1, ss: 0.05, dd: 5.4, isCurrent: false },
    ...
    { aa: 5.5, ss: 1.58, dd: 33.23, isCurrent: true },
    ...
    { aa: 10, ss: 5.4, dd: 69.08, isCurrent: false },
    ...
    { aa: 15, ss: 12.55, dd: 119.8, isCurrent: false },
    { aa: 16, ss: 14.4, dd: 131.64, isCurrent: false },
    { aa: 17, ss: 16.4, dd: 144.1, isCurrent: false },
    ...
    { aa: 23, ss: 32.04, dd: 234.3, isCurrent: false },
    ...
    { aa: 30, ss: 60.44, dd: 382.3, isCurrent: false },
    ...
    { aa: 35, ss: 90.27, dd: 526.5, isCurrent: false },
    { aa: 36, ss: 97.49, dd: 560.13, isCurrent: false },
    { aa: 37, ss: 105.2, dd: 595.57, isCurrent: false },
    { aa: 38, ss: 113.44, dd: 632.9, isCurrent: false },
    { aa: 39, ss: 122.23, dd: 672.22, isCurrent: false },
    { aa: 40, ss: 131.64, dd: 713.66, isCurrent: false },
    { aa: 41, ss: 141.69, dd: 757.3, isCurrent: false },
    ...
    { aa: 51, ss: 291.39, dd: 1345.1, isCurrent: false },
    { aa: 52, ss: 313.08, dd: 1422.5, isCurrent: false },
    ...
    { aa: 68, ss: 1027.2, dd: 3404.72, isCurrent: false },
    ...
    { aa: 96, ss: 12198.58, dd: 14908.5, isCurrent: false },
    { aa: 97, ss: 13493.38, dd: 15707.06, isCurrent: false },
    { aa: 98, ss: 14939.66, dd: 16547.98, isCurrent: false },
    { aa: 99, ss: 16556.61, dd: 17433.5, isCurrent: false },
    { aa: 100, ss: 18366.0, dd: 18366.0, isCurrent: false },
  ];
          ...
          <p className={`label text-[${props.payload[0].stroke}]`}>
            {
              data.find(
                (item: any) =>
                  item.ss === props.payload[1].payload.ss &&
                  item.dd === props.payload[2].payload.dd
              )?.aa
            }
            %
          </p>
