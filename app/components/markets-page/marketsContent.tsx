...
import MarketsContentEmpty from "./emptyMarketsContent";
                ...
                return (
                  <div key={index} className="flex flex-col gap-y-[10px]">
                    <label className="flex justify-between text-sm md:text-base leading-[20px] md:leading-[22px]">
                      ...
                      <div key={index} className="text-[#00ABFF]">
                    ...
                    <div className="border-custom px-3 relative top__custom">
                      ...
                      <div className="w-full flex absolute bottom-0 left-0">
                        <div className="bg-[#00ABFF] h-[3px] flex-grow"></div>
                      </div>
                    </div>
                  </div>
                );
                  ...
                  >
                    ...
                    <td>
                      ...
                      >
                        ...
                        <div className="!flex items-center break-words bg-dark-green text-[#00ABFF] rounded-md text-[11px] md:text-xs text-center h-[20px] md:h-[22px] px-[5px] absolute top-[40px] md:top-[61px] left-[15px]">
                          <DisplayPrice
                        ...
                        >
                          <div className="absolute top-[40px] md:top-[61px] left-[15px] h-[22px]">
                            <div
                              ...
                              className="!flex items-center break-words bg-[#181D1B] text-[#00ABFF] rounded-md text-[11px] text-center h-[20px] px-[5px]"
                            >
                              <img
                                aria-hidden={true}
                            ...
                            >
                              <div className="absolute top-[40px] md:top-[61px] left-[15px] h-[22px]">
                                <div
                                  ...
                                  className="!flex items-center break-words bg-[#181D1B] text-[#00E0FF] rounded-md text-[11px] text-center h-[20px] px-[5px]"
                                >
                                  <img
                                    aria-hidden={true}
                                    className="w-[13px] h-[13px]"
                                  ...
                                  <div className="relative z-10 leading-none whitespace-no-wrap shadow-lg w-[100%] mx-[0px] !rounded-[10px] panel-custom">
                                    <div className="flex-col w-full h-full bg-[#181D1B] shadow-lg rounded-[10px] pt-[14px] pr-[16px] pb-[14px] pl-[16px]">
                                      <div className="flex justify-between gap-[30px] mb-[12px] last:mb-[0]">
                                        ...
                                        <span
                                          className={`font-nova text-[#00E0FF] text-sm font-normal ${checkColorClass(
                                            borrowApy
                                          )}`}
                                        >
                                          {formatApy(borrowApy)}
