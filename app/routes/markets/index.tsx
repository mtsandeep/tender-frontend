import MarketRow from "~/components/two-panels/market-borrow-row";
      ...
      >
        <div key="1" className="panel-custom border-custom">
          ...
          >
            <div
              key="1"
              className="flex items-center gap-x-[10px] mb-[25px] md:mb-[30px] font-normal"
            >
              <div
                key="1"
              ...
              <div
                key="2"
                className="text-[14] md:text-[18px] leading-[14px] md:leading-[18px] text-[#14f195]"
              >
                <span>+</span>
                <span>0.14</span>
                <span>%</span>
        ...
        <div key="2" className="panel-custom border-custom">
          ...
          >
            ...
            >
              ...
              <div
                key="2"
                className="text-[14] md:text-[18px] leading-[14px] md:leading-[18px] text-[#CF0C0C]"
              >
                <span>-</span>
                <span>0.14</span>
                <span>%</span>
            ...
            <table className="custom__scroll w-full h-full table-fixed !pb-[23px] md:pb-[0px]  md:pt-[0px]">
              <thead>
                <tr className="w-full text-xs text-[#818987] border-b border-[#282C2B] ">
                  ...
                  <th className="whitespace-nowrap font-nova font-[500] md:whitespace-normal pr-[36px]  md:pr-[2px] text-right text-[12px] md:text-[14px]">
                    Total Supply
                  </th>
                  <th className="whitespace-nowrap font-nova font-[500] md:whitespace-normal pr-[36px]  md:pr-[14px] text-right text-[12px] md:text-[14px]">
                    Supply APY
                  </th>
                  <th className="whitespace-nowrap font-nova font-[500] md:whitespace-normal pr-[36px]  md:pr-[20px] text-right text-[12px] md:text-[14px]">
                    Total Borrow
                  </th>
                  <th className="whitespace-nowrap font-nova font-[500] md:whitespace-normal pr-[36px]  md:pr-[30px] md:pl-[0px] text-right text-[12px] md:text-[14px]">
                    Borrow APY
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                {array.map((m: any, index: number) => {
                  return (
                    <tr
                      key={index}
                      className="border-t border-[#282C2B] border__top__custom cursor-pointer hover:bg-[#151515] border-child-hover"
                    >
                      <td className="relative text-white font-nova font-normal md:t-[0] pl-[15px] pt-[8px] pb-[26px] md:pt-[24px] md:pb-[23px] md:pl-[30px] md:pr-[0px]">
                        <div className="flex items-start md:items-center justify-left relative top-[8px] md:top-[-1px]">
                          <img
                      ...
                      <td className="whitespace-nowrap text-right md:whitespace-normal relative text-white font-nova font-normal pb-[0] md:pb-[26px] pl-[44px] pr-[36px] md:pr-[2px]">
                        <div className="custom__hidden text-[14px] leading-[20px] relative top-[-13px] md:top-[0]">
                        ...
                        <div className="custom__hidden break-words bg-[dark-green] text-[dark-green] rounded-md text-[11px] md:text-[12px] h-[20px] md:h-[22px] px-[5px] absolute top-[42px] md:top-[50px] right-[36px] md:right-[2px] w-fit">
                          {`$${
                            m.marketData?.totalBorrowed &&
                            toShortFiatString(
                              m.marketData.totalBorrowed *
                      ...
                      <td className="relative text-white text-right font-nova font-normal pb-[0] md:pb-[26px] pl-[44px] pr-[36px] md:pr-[13px]">
                        <div className="custom__hidden text-[14px] leading-[20px] md:text-[16px] md:leading-[22px] relative top-[-13px] md:top-[0]">
                        ...
                        >
                          <div className=" !flex items-center break-words text-[11px] md:text-[12px] text-right h-[20px] md:h-[22px] px-[5px] absolute top-[42px] md:top-[50px] right-[36px] md:right-[13px] w-fit">
                            -
                          </div>
                          <div className="hidden flex-row md:flex-col bottom__custom items-center group-hover:flex rounded-[4px] md:rounded-[15px] w-fit">
                      ...
                      <td className="relative text-white text-right font-nova font-normal pb-[0] md:pb-[26px] pl-[44px] pr-[36px] md:pr-[21px] md:pl-[10px]">
                        <div className="custom__hidden text-[14px] leading-[20px] md:text-[16px] md:leading-[22px] relative top-[-13px] md:top-[0]">
                          {toShortCryptoString(
                        ...
                        <div className="custom__hidden !flex items-center  break-words bg-[#3A1313] text-[#FF3939] rounded-[4px] md:rounded-md text-[11px] md:text-[12px] text-right h-[20px] md:h-[22px] px-[5px] absolute top-[42px] md:top-[50px] right-[36px] md:right-[21px] w-fit">
                          {`$${toShortFiatString(
                            m.maxBorrowLiquidity * m.tokenPair.token.priceInUsd
                          )} USD`}
                        </div>
                      </td>
                      <td className="relative text-white font-nova font-normal text-right pb-[0] md:pb-[26px] pl-[44px] pr-[36px] md:pr-[30px] md:pl-[10px]">
                        <div className="custom__hidden text-[14px] leading-[20px] md:text-[16px] md:leading-[22px] relative top-[-13px] md:top-[0]">
                          {toShortCryptoString(
                            Number(m.maxBorrowLiquidity.toFixed(2))
                          )}{" "}
                        ...
                        <div className="custom__hidden !flex items-center break-words bg-dark-green text-dark-green rounded-[4px] md:rounded-md text-[11px] md:text-[12px] text-right h-[20px] md:h-[22px] px-[5px] absolute top-[42px] md:top-[50px] right-[36px] md:right-[30px] w-fit">
                          {`$${toShortFiatString(
                            m.maxBorrowLiquidity * m.tokenPair.token.priceInUsd
                          )} USD`}
                        </div>
